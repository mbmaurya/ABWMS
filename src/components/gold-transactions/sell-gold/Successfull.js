    ...
    >
      <div style={{ ...box, padding: "30px" }}>
        <Row>
          <Col>
            <center>
              <h3 style={HeadingStyles}>Gold Sell Successfully!</h3>
              <SuccessfullIcon />
              <p style={TransactionInfoStyles}>
                Gold worth
                <span style={BoldFontStyles}> &#x20B9;{cost}</span> sold
                successfully,
                <br />
                amount will be credited to HDFC Bank with in 48hrs.
              </p>
            </center>
...
export default SellGoldSuccessfully;
